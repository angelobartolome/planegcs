...
// Akwardly in some systems flushing does not force the write to the file, requiring a close
    ...
    int System::addConstraint(Constraint *constr)
    {
        isInit = false;
        if (constr->getTag() >= 0)
        {                         // negatively tagged constraints have no impact
    ...
    int System::addConstraintLinearInstance(Point &p0,
                                            Point &pk,
                                            Point &dirP1,
                                            Point &dirP2,
    ...
    {
        // Add two independent constraints: X and Y components
        Constraint *constrX = new ConstraintLinearInstanceX(p0, pk, dirP1, dirP2, base_distance, N);
        constrX->setTag(tagId);
        constrX->setDriving(driving);
        addConstraint(constrX);

        Constraint *constrY = new ConstraintLinearInstanceY(p0, pk, dirP1, dirP2, base_distance, N);
        constrY->setTag(tagId);
        constrY->setDriving(driving);
        return addConstraint(constrY);
    }
                                                                   ...
                                                                   bool driving)
    {
        ...
        double closertopositivemajor =
            pow(X_1 - X_c - (X_F1 - X_c) * sqrt(pow(b, 2) + pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)) / sqrt(pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)),
                2) -
            pow(X_2 - X_c - (X_F1 - X_c) * sqrt(pow(b, 2) + pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)) / sqrt(pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)),
                2) +
            pow(Y_1 - Y_c - (Y_F1 - Y_c) * sqrt(pow(b, 2) + pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)) / sqrt(pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)),
                2) -
            pow(Y_2 - Y_c - (Y_F1 - Y_c) * sqrt(pow(b, 2) + pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)) / sqrt(pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)),
                2);
                                                                   ...
                                                                   bool driving)
    {
        ...
        double closertopositiveminor =
            pow(X_1 - X_c + b * (Y_F1 - Y_c) / sqrt(pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)), 2) - pow(X_2 - X_c + b * (Y_F1 - Y_c) / sqrt(pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)), 2) + pow(-Y_1 + Y_c + b * (X_F1 - X_c) / sqrt(pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)), 2) - pow(-Y_2 + Y_c + b * (X_F1 - X_c) / sqrt(pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)), 2);
                                                                     ...
                                                                     bool driving)
    {
        ...
        double closertopositivemajor =
            pow(-X_1 + X_c + (X_F1 - X_c) * (-pow(b, 2) + pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)) / sqrt(pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)),
                2) -
            pow(-X_2 + X_c + (X_F1 - X_c) * (-pow(b, 2) + pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)) / sqrt(pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)),
                2) +
            pow(-Y_1 + Y_c + (Y_F1 - Y_c) * (-pow(b, 2) + pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)) / sqrt(pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)),
                2) -
            pow(-Y_2 + Y_c + (Y_F1 - Y_c) * (-pow(b, 2) + pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)) / sqrt(pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)),
                2);
                                                                     ...
                                                                     bool driving)
    {
        ...
        double closertopositiveminor =
            pow(-X_1 + X_c + b * (Y_F1 - Y_c) / sqrt(pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)) + (X_F1 - X_c) * (-pow(b, 2) + pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)) / sqrt(pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)),
                2) -
            pow(-X_2 + X_c + b * (Y_F1 - Y_c) / sqrt(pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)) + (X_F1 - X_c) * (-pow(b, 2) + pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)) / sqrt(pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)),
                2) +
            pow(-Y_1 + Y_c - b * (X_F1 - X_c) / sqrt(pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)) + (Y_F1 - Y_c) * (-pow(b, 2) + pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)) / sqrt(pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)),
                2) -
            pow(-Y_2 + Y_c - b * (X_F1 - X_c) / sqrt(pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)) + (Y_F1 - Y_c) * (-pow(b, 2) + pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)) / sqrt(pow(X_F1 - X_c, 2) + pow(Y_F1 - Y_c, 2)),
                2);
    ...
    int System::solve(SubSystem *subsysA, SubSystem *subsysB, bool /*isFine*/, bool isRedundantsolving)
    {
        ...
        for (int iter = 1; iter < maxIterNumber; iter++)
        {
            ...
            // line search
            {
                ...
                // Eq. 18.36
                mu = std::max(mu,
                              (grad.dot(xdir) + std::max(0., 0.5 * xdir.dot(B * xdir))) / ((1. - rho) * resA.lpNorm<1>()));
                                     ...
                                     std::map<int, int> &tagmultiplicity)
    {
        ...
        if (jacobianconstraintcount == 0)
        { // only driven constraints
            J.resize(0, 0);
        }
    }
            ...
            auto iterMostPopular = std::max_element(
                ...
                [&tagmultiplicity](const auto &pair1, const auto &pair2)
                {
                    ...
                    return (sizeOfSet2 > sizeOfSet1                                                                                // (1)
                            || (sizeOfSet2 == sizeOfSet1 && tagmultiplicity.at(tag2) < tagmultiplicity.at(tag1))                   // (2)
                            || (sizeOfSet2 == sizeOfSet1 && tagmultiplicity.at(tag2) == tagmultiplicity.at(tag1) && tag2 > tag1)); // (3)
                });
